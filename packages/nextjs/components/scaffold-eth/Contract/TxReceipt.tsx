...
export const TxReceipt = (
  ...
  return (
    ...
    <div className="flex text-sm rounded peer-checked:rounded-b-none min-h-0 bg-base-100 py-0">
      ...
      <div className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-title text-xs min-h-0 py-1.5 pl-1">
          <strong>Transaction Receipt</strong>
        </div>
        <div className="collapse-content overflow-auto rounded-t-none">
